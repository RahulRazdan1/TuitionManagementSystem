...
{
    public class GetSlotRequestsQuery : QueryAsync<long, long, IList<SlotRequest>>
    {
        public GetSlotRequestsQuery(Providers provider) : base(provider) { }
        public override async Task<IList<SlotRequest>> ExecuteAsync(long tuteeId = 0, long tutorId = 0)
        {
            ...
            return await (from sl in db.SlotRequest
                          ...
                          sl.TuteeId == (tuteeId == 0 ? sl.TuteeId : tuteeId) &&
