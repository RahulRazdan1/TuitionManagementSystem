...
{
    public class CancelSlotModel : PageModel
    {
        ...
        public CancelSlotModel(Providers providers, UserContext userContext, IEmailer emailer)
        {
        ...
        public async Task<IActionResult> OnPostDelete()
        {
            ...
            var result = editSlotRequest.ExecuteSyncCancel(Input);
            ...
            string body = "Hi " + SlotRequest.Tutee.Name + ", <BR/>The slot request of subject " + SlotRequest.Subject.Name +
                          " with course " + SlotRequest.Course.Name + " is canceled by " + SlotRequest.Tutor.Name +
                          " and canceled time is :" + SlotRequest.AcceptedSlotTime + " on Date :" + SlotRequest.Date.ToShortDateString() + ". <BR/>Thanks, <BR/>Eagle Tutoring.";
            ...
            body = "Hi " + SlotRequest.Tutor.Name + ", <BR/>The slot request of subject " + SlotRequest.Subject.Name +
                          " with course " + SlotRequest.Course.Name + " is canceled by you.<BR/>" +
                          " Canceled time is :" + SlotRequest.AcceptedSlotTime + " on Date :" + SlotRequest.Date.ToShortDateString() + ". <BR/>Thanks, <BR/>Eagle Tutoring.";
